...
contract Pinger is MultiIncreasingTreasuryReimbursement {
    constructor(bytes32 coinName, address treasury_, uint256 baseUpdateCallerReward_, uint maxUpdateCallerReward_, uint perSecondCallerRewardIncrease_) public
    MultiIncreasingTreasuryReimbursement(coinName, treasury_, baseUpdateCallerReward_, maxUpdateCallerReward_, perSecondCallerRewardIncrease_)
    {}
...
contract MultiIncreasingTreasuryReimbursementTest is DSTest {
    Hevm hevm;
    ...
    function setUp() public {
        ...
        pinger = new Pinger(coinName, address(treasury), baseCallerReward, maxCallerReward, perSecondCallerRewardIncrease);
    ...
    function test_get_caller_reward_null_rewards() public {
        pinger = new Pinger(coinName, address(treasury), 0, 0, perSecondCallerRewardIncrease);
    ...
    function test_get_caller_reward_base_reward_zero() public {
        pinger = new Pinger(coinName, address(treasury), 0, maxCallerReward, perSecondCallerRewardIncrease);
    ...
    function test_get_caller_reward_both_rewards_max_uint() public {
        pinger = new Pinger(coinName, address(treasury), uint(-1), uint(-1), perSecondCallerRewardIncrease);
    ...
    function test_get_caller_reward_computed_reward_higher_than_max() public {
        pinger = new Pinger(coinName, address(treasury), 1 ether, 1 ether + 1, perSecondCallerRewardIncrease);
    ...
    function test_reward_caller_treasury_reverts() public {
        ...
        pinger = new Pinger(coinName, address(revertTreasury), 1 ether, 1 ether + 1, perSecondCallerRewardIncrease);
