...
import "../relayer/IncreasingRewardRelayer.sol";
...
contract User {
    function doReimburseCaller(IncreasingRewardRelayer relayer, address feeReceiver) external {
        relayer.reimburseCaller(feeReceiver);
    }
}

contract IncreasingRewardRelayerTest is DSTest {
    Hevm hevm;
    ...
    function setUp() public {
        ...
        relayer = new IncreasingRewardRelayer(
          address(this), address(treasury), baseCallerReward, maxCallerReward, perSecondCallerRewardIncrease, reimburseDelay
        );
