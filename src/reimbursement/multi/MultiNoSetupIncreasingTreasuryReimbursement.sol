...
contract MultiNoSetupIncreasingTreasuryReimbursement is GebMath {
    // --- Auth ---
    ...
    **/
    modifier isAuthorized {
        require(authorizedAccounts[msg.sender] == 1, "MultiNoSetupIncreasingTreasuryReimbursement/account-not-authorized");
        _;
    }
